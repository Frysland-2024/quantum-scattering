...
class PacketCase:
    ...
    center: float
    snapshot_times: tuple[float, float, float, float]
...
def reference_cases(second_peak_energy: float) -> tuple[PacketCase, ...]:
    """Build the Part 4 cases using Part 3's finite-difference second peak."""
